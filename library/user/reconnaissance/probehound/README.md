...
When a client is detected, an alert tone will play and the client's BSSID, signal strength, and the target SSID will be displayed. After detection, the script will pause and ask user if they wish to continue sniffing or exit.
